...
store.dispatch((0, _actions.addTodo)('Do stuff'));
store.dispatch((0, _actions.toggleTodo)(0));
store.dispatch((0, _actions.toggleTodo)(1));
store.dispatch(_actions.VisibilityFilters.SHOW_COMPLETED);

unsubscribe();

},{"./actions":1,"./reducers":17,"redux":9}],3:[function(require,module,exports){
...
},{"lodash/isPlainObject":14,"symbol-observable":15}],9:[function(require,module,exports){
(function (process){
'use strict';
